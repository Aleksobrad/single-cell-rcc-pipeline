...
cytek_seurat$tissue=mapvalues(cytek_seurat$tissue, from = c("1","2"), to = c("Normal", "Tumor"))
...
tiff("cytek_lymphoid_resolution.tiff", width = 6, height = 6, units = 'in', res = 600)
...
cytek_seurat$seurat_clusters=mapvalues(cytek_seurat$seurat_clusters, from = 1:length(unique(cytek_seurat$seurat_clusters))-1, to = c("CD8 T-cell","CD4 T-cell","Myeloid","B-cell"))
Idents(cytek_seurat) <- "seurat_clusters"
tiff("cytek_lymphoid_louvain.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat, reduction = "umap",label.size=12,label = TRUE,cols=c("mediumorchid2","darkgoldenrod2","cyan4","lightsteelblue3"),repel=T) + NoLegend()
dev.off()
...
tiff("cytek_lymphoid_heatmap.tiff", width = 6, height = 4, units = 'in', res = 600)
#geneHeatmap_viper(cytek_seurat,cytek_seurat$seurat_clusters,unique(cytek_seurat.markers$gene))
geneHeatmap(cytek_seurat,cytek_seurat$seurat_clusters,unique(cytek_seurat.markers$gene),viper=T,scaled=F,genes_by_cluster = F,color_palette = c("mediumorchid2","darkgoldenrod2","cyan4","lightsteelblue3"))
dev.off()
tiff("cytek_lymphoid_louvain_split.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat, reduction = "umap",label = TRUE,split.by = "tissue",cols=c("mediumorchid2","darkgoldenrod2","cyan4","lightsteelblue3")) + NoLegend()
dev.off()
tiff("cytek_lymphoid_louvain_split_patient.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat, reduction = "umap",label = TRUE,split.by = "patient",ncol=3,cols=c("mediumorchid2","darkgoldenrod2","cyan4","lightsteelblue3")) + NoLegend()
dev.off()
...
cytek_seurat_m$tissue=mapvalues(cytek_seurat_m$tissue, from = c("1","2"), to = c("Normal", "Tumor"))
...
sd=out[[2]]
x=seq(0.01,0.1,by=0.01)
tiff("cytek_myeloid_resolution.tiff", width = 6, height = 6, units = 'in', res = 600)
errbar(x,means,means+sd,means-sd,ylab="mean silhouette score",xlab="resolution parameter")
lines(x,means)
dev.off()
best=tail(x[which(means==max(means))],n=1)
...
cytek_seurat_m$seurat_clusters=mapvalues(cytek_seurat_m$seurat_clusters, from = 1:length(unique(cytek_seurat_m$seurat_clusters))-1, to = c("Lymphoid","Monocyte 1","Monocyte 2","Monocyte 3","Macrophage","B-cell"))
Idents(cytek_seurat_m) <- "seurat_clusters"
tiff("cytek_myeloid_louvain.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat_m, reduction = "umap",label = TRUE,label.size=12,cols=c("darkgoldenrod2","cyan2","deepskyblue","dodgerblue3","cyan4","lightsteelblue3"),repel=T) + NoLegend()
dev.off()
...
tiff("cytek_myeloid_heatmap.tiff", width = 6, height = 4, units = 'in', res = 600)
#geneHeatmap_viper(cytek_seurat_m,cytek_seurat_m$seurat_clusters,unique(cytek_seurat_m.markers$gene))
geneHeatmap(cytek_seurat_m,cytek_seurat_m$seurat_clusters,unique(cytek_seurat_m.markers$gene),viper=T,scaled=F,genes_by_cluster = F,color_palette = c("darkgoldenrod2","cyan2","deepskyblue","dodgerblue3","cyan4","lightsteelblue3"))
dev.off()
tiff("cytek_myeloid_louvain_split.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat_m, reduction = "umap",label = TRUE,split.by = "tissue",cols=c("darkgoldenrod2","cyan2","deepskyblue","dodgerblue3","cyan4","lightsteelblue3")) + NoLegend()
dev.off()
tiff("cytek_myeloid_louvain_split_patient.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(cytek_seurat_m, reduction = "umap",label = TRUE,split.by = "patient",ncol=3,cols=c("darkgoldenrod2","cyan2","deepskyblue","dodgerblue3","cyan4","lightsteelblue3")) + NoLegend()
dev.off()
...
tiff("cytek_lymphoid_heatmap_gene.tiff", width = 6, height = 4, units = 'in', res = 600)
geneHeatmap(gene_a,gene_a$seurat_clusters,lymphoid_genes,viper=T,scaled=T,genes_by_cluster = F)
dev.off()
tiff("cytek_lymphoid_louvain_gene.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(gene_a, reduction = "umap",label = TRUE) + NoLegend()
dev.off()
...
vp_a$seurat_clusters=mapvalues(vp_a$seurat_clusters, from = 1:length(unique(vp_a$seurat_clusters))-1, to = c("CD4 T-cell","NK cell","Macrophage","Monocyte","CD8 T-cell","Treg","B-cell"))
...
tiff("cytek_lymphoid_heatmap_vp.tiff", width = 6, height = 4, units = 'in', res = 600)
geneHeatmap(vp_a,vp_a$seurat_clusters,lymphoid_genes[lymphoid_genes %in% pos_genes_intersect],viper=T,scaled=T,genes_by_cluster = F,color_palette = c("darkgoldenrod2","forestgreen","cyan4","cyan2","mediumorchid2","darkorange3","lightsteelblue3"))
dev.off()
tiff("cytek_lymphoid_louvain_vp.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(vp_a, reduction = "umap",label = TRUE,label.size=12,cols=c("darkgoldenrod2","forestgreen","cyan4","cyan2","mediumorchid2","darkorange3","lightsteelblue3"),repel=T) + NoLegend()
dev.off()
...
tiff("cytek_myeloid_heatmap_gene.tiff", width = 6, height = 4, units = 'in', res = 600)
geneHeatmap(gene_a,gene_a$seurat_clusters,myeloid_genes,viper=T,scaled=T,genes_by_cluster = F)
dev.off()
tiff("cytek_myeloid_louvain_gene.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(gene_a, reduction = "umap",label = TRUE) + NoLegend()
dev.off()
...
best=tail(x[which(means==max(means))],n=1)
vp_a$seurat_clusters=vp_a@meta.data[,which(colnames(vp_a@meta.data)==paste("RNA_snn_res.",best,sep=""))]
vp_a$seurat_clusters=mapvalues(vp_a$seurat_clusters, from = 1:length(unique(vp_a$seurat_clusters))-1, to = c("CD4 T-cell","Monocyte","CD8 T-cell","Macrophage","B-cell","Epithelial"))
Idents(vp_a) <- "seurat_clusters"
#DimPlot(vp_a, reduction = "umap",label = TRUE) + NoLegend()
#geneHeatmap_viper(vp_a,vp_a$seurat_clusters,myeloid_genes[myeloid_genes %in% pos_genes_intersect])
tiff("cytek_myeloid_heatmap_vp.tiff", width = 6, height = 4, units = 'in', res = 600)
geneHeatmap(vp_a,vp_a$seurat_clusters,myeloid_genes[myeloid_genes %in% pos_genes_intersect],viper=T,scaled=T,genes_by_cluster = F,color_palette = c("darkgoldenrod2","cyan2","mediumorchid2","cyan4","lightsteelblue3","gray"))
dev.off()
tiff("cytek_myeloid_louvain_vp.tiff", width = 6, height = 6, units = 'in', res = 600)
DimPlot(vp_a, reduction = "umap",label = TRUE,label.size=12,cols=c("darkgoldenrod2","cyan2","mediumorchid2","cyan4","lightsteelblue3","gray"),repel=T) + NoLegend()
dev.off()
